...
import 'package:my_app/notifier/reply_comment_supply_notifier.dart';
...
final replyCommentSupplyNotifierProvider = ChangeNotifierProvider<ReplyCommentSupplyNotifier>((ref) {
  return ReplyCommentSupplyNotifier();
});